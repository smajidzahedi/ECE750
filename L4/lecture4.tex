 ...
 \section{Brief Overview of (Mixed Integer) Linear Programming}
  ...
  \begin{frame}{Solving Mixed Linear/Integer Programs}
   ...
   \setlength{\itemsep}{1.5em}
    ...
    \begin{itemize}
     \item Gurobi, MOSEK, GNU Linear Programming Kit, CPLEX, CVXPY, etc.
    \end{itemize}
 ...
 \section{Dominated Strategies}
  ...
  \begin{frame}{Path Dependency of Iterated Dominance}
   ...
   \begin{frame}{Computational Questions for Iterated Dominance}
    \begin{itemize}[<+->]
    \setlength{\itemsep}{1.2em}
     \item Does there exist some elimination path under which $s_i$ is eliminated?
     \item Does there exist maximally reduced game where each agent has exactly 1 action?
 ...
 \section{Minmax and Maxmin Strategies}
  ...
  \begin{frame}{Maxmin Strategy and Value}
   \begin{itemize}
    ...
    \item<4-> Objective of this LP, $u$, is \alert{maxmin value} of agent $i$
   \end{itemize}
  \end{frame}
