...
\begin{document}
 ...
 \section{Dominant Strategy Equilibrium}
  \begin{frame}{Mixed and Pure Strategies}
   \begin{itemize}[<+->]
    ...
    \item Let $\Omega(X)$ be set of all probability distributions over $X$
    \item Set of \alert{(mixed) strategies} for agent $i$ is denoted by $S_i = \Omega(A_i)$
 ...
 \section{Nash Equilibrium}
  ...
  \begin{frame}{Example: Battle of Sexes}
   \begin{itemize}
    ...
    \end{center}
    \vspace{10pt}
    \item Are these the only Nash equilibria?
   \end{itemize}
  \end{frame}
 ...
 \section{Rationalizability} 
  ...
  \begin{frame}{Example: Matching Pennies}
   ...
   \end{center}
   \begin{itemize}[<+->]
    \item Row playing H is rationalizable (Row could believe Col plays H)
    \item Col playing H is rationalizable (Col could believe Row plays T)
    \item Row playing T is rationalizable (Col could believe Row believes Col plays T)
    \item $\dots$
  ...
  \begin{frame}{Example: 2/3-Beauty Contest Game}
   \begin{itemize}[<+->]
    ...
    \item $\dots$
    \item Only rationalizable action is playing 0
   \end{itemize}
  \end{frame}
   ...
   \begin{columns}
    \begin{column}{0.6\textwidth}
      ...
      \begin{itemize}[<+->]
       ...
       \item Expected utilizes is $\left(0,0\right)$, so nobody dies!
      \end{itemize}
    \end{column}
    \begin{column}{0.28\textwidth}
     \begin{center}
